...
import {
  ...
  getAnyOrderById,
  listDeliveryDriversForOrder,
} from '../../services/orderService.js';
import { getParam, handleOrderError } from '../shared/orderHttp.js';

export async function getOrderDeliveryDrivers(req: AuthRequest, res: Response): Promise<void> {
  ...
  try {
    ...
    const drivers = await listDeliveryDriversForOrder(orderId);
    res.json({ drivers });
  } catch (err) {
